...
/*
Biblioteca para Calculo de matriz no corpo dos Reais e complexos em C.
...
//===============================DIAGONALIZAÃ‡ÃƒO DE MATRIZES===============================
/*
double **diagmatrix(double **m, int s)
{
double **D=(matrix)allocmatrix(s,s,sizeof(double));
}
*/
